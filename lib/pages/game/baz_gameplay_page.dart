...
class HorizontalNumberSelectorBaz extends StatefulWidget {
  ...
  const HorizontalNumberSelectorBaz(
    ...
    return ShaderMask(
      ...
      child: ScrollSnapList(
        ...
        onItemFocus: (index) {
          ...
          final baz = currentPlayersProvider.scrollableNumberList[index];
          currentPlayersProvider.updatePlayerCurrentBaz(
              widget.currentPlayer, baz);
