...
import 'package:pocha_points_tracker/pages/game/winner_gameplay_page_spectator.dart';
        ...
        builder: (context, snapshot) {
          ...
          return StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshotAchievements) {
                  ...
                  for (final doc in snapshotAchievements.data!.docs) {
                    ...
                    if (completed.isNotEmpty) {
                      ...
                      if (!completedAchievements.contains(achievementKey) &&
                          !_shownAchievements.contains(achievementKey)) {
                        _shownAchievements.add(achievementKey);
                ...
                if (status == 'finished' && !_hasNavigatedToWinner) {
                  _hasNavigatedToWinner = true; // Evita navegar varias veces
                  Future.delayed(const Duration(milliseconds: 300), () {
                    final provider =
                        Provider.of<CurrentPlayers>(context, listen: false);
                    if (provider.showAchievement) {
                      provider.onLastAchievementClosed = () {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (context) => WinnerGameplayPageSpectator(
                  ...
                  return SafeArea(
                    child: Stack(
                      children: [
                        ...
                        if (value.showAchievement &&
                            value.currentAchievement != null)
                          AchievementOverlay(
                            key: ValueKey(
