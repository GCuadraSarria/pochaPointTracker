...
class _RankingPageState extends State<RankingPage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(() => context.read<CurrentPlayers>().setAllPlayersList());
  }
                ...
                children: [
                        ...
                        StreamBuilder<QuerySnapshot>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            if (snapshot.hasData) {
                              ...
                              print(
                                  'Jugadores recibidos del stream 1: ${playersList.map((doc) => doc['playerName']).toList()}');
                  ...
                  Flexible(
                    child: Builder(builder: (context) {
                      final selectedPlayers = currentPlayersProvider
                          .allPlayersList
                          .where((p) => p.selected)
                          .toList();
                      print(
                          'Jugadores seleccionados para ranking: ${selectedPlayers.map((p) => p.playerName).toList()}');
                      ...
                      return StreamBuilder<QuerySnapshot>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (snapshot.hasData) {
                            List playersList = snapshot.data!.docs;
                            print(
                                'Jugadores recibidos del stream 2: ${playersList.map((doc) => doc['playerName']).toList()}');
                  ...
                  CustomButton(
                    ...
                    width: 340.0,
                    onPressed: () {
                      context.read<CurrentPlayers>().selectAllPlayers();
                      Navigator.push(
                        context,
                        MaterialPageRoute(
